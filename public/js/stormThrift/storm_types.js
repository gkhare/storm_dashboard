  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.I32) {
        this.int_arg = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.I64) {
        this.long_arg = input.readI64().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.STRING) {
        this.string_arg = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.BOOL) {
        this.bool_arg = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.binary_arg = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.DOUBLE) {
        this.double_arg = input.readDouble().value;
      } else {
        input.skip(ftype);
      }
      break;
...
JavaObject.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.full_class_name = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
Grouping.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 7:
      if (ftype == Thrift.Type.STRING) {
        this.custom_serialized = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
StreamInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.BOOL) {
        this.direct = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ShellComponent.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.execution_command = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ComponentObject.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.serialized_java = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ComponentCommon.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.I32) {
        this.parallelism_hint = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.json_conf = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
AlreadyAliveException = function(args) {
  this.msg = null;
  if (args) {
...
NotAliveException = function(args) {
  this.msg = null;
  if (args) {
    if (args.msg !== undefined) {
      this.msg = args.msg;
...
InvalidTopologyException = function(args) {
  this.msg = null;
  if (args) {
    if (args.msg !== undefined) {
      this.msg = args.msg;
...
TopologySummary.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.I32) {
        this.num_executors = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.I32) {
        this.num_workers = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.I32) {
        this.uptime_secs = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
SupervisorSummary = function(args) {
  this.host = null;
  this.uptime_secs = null;
  this.num_workers = null;
...
SupervisorSummary.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.I32) {
        this.num_used_workers = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.supervisor_id = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ClusterSummary.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.nimbus_uptime_secs = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ErrorInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.error_time_secs = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i95 = 0; _i95 < _size90; ++_i95)
        {
          ...
          for (var _i103 = 0; _i103 < _size98; ++_i103)
          {
            ...
            var key104 = null;
            var val105 = null;
            key104 = new GlobalStreamId();
            key104.read(input);
            val105 = input.readI64().value;
            val97[key104] = val105;
          }
          input.readMapEnd();
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i127 = 0; _i127 < _size122; ++_i127)
        {
          ...
          for (var _i135 = 0; _i135 < _size130; ++_i135)
          {
            ...
            var key136 = null;
            var val137 = null;
            key136 = new GlobalStreamId();
            key136.read(input);
            val137 = input.readDouble().value;
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i143 = 0; _i143 < _size138; ++_i143)
        {
          ...
          for (var _i151 = 0; _i151 < _size146; ++_i151)
          {
            ...
            var key152 = null;
            var val153 = null;
            key152 = new GlobalStreamId();
            key152.read(input);
            val153 = input.readI64().value;
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i159 = 0; _i159 < _size154; ++_i159)
        {
          ...
          for (var _i167 = 0; _i167 < _size162; ++_i167)
          {
            ...
            var key168 = null;
            var val169 = null;
            key168 = new GlobalStreamId();
            key168.read(input);
            val169 = input.readDouble().value;
...
ExecutorSpecificStats = function(args) {
  this.bolt = null;
  this.spout = null;
  if (args) {
...
ExecutorInfo.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.task_start = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 2:
      if (ftype == Thrift.Type.I32) {
        this.task_end = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
ExecutorSummary.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
      if (ftype == Thrift.Type.STRING) {
        this.component_id = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
KillOptions.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.wait_secs = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
RebalanceOptions = function(args) {
  this.wait_secs = null;
  this.num_workers = null;
  this.num_executors = null;
  if (args) {
...
SubmitOptions.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.I32) {
        this.initial_status = input.readI32().value;
      } else {
        input.skip(ftype);
      }
      break;
...
DRPCRequest.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.func_args = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
DRPCExecutionException = function(args) {
  this.msg = null;
  if (args) {
    if (args.msg !== undefined) {
      this.msg = args.msg;
